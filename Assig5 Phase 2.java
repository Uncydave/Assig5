...
class GUICard {
	...
	static void loadCardIcons(){
		/*
		 * Check if the Icon array has already been built. 
		 * Build the Icon array 
		 */
	}

	static public Icon getIcon(Card card){
		/*
		 * Takes a card object and returns the appropriate Icon
		 */
		return iconCards[valueAsInt(card)][suitAsInt(card)];
	}
	static public Icon getBackCardIcon(){
		/*
		 * Gets the Icon for the back of a card
		 */
		return iconBack;
	}
}
